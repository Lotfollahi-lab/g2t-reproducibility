...
exec python scripts/run_scgg_inference.py --data_dir /nfs/team361/sb75/DATASETS/silver/mmc_luna --checkpoint /nfs/team361/sb75/scgg-reproducibility/artifacts/mmc_luna/scgg_model/20260530_165229/best_model.ckpt --seed 0
